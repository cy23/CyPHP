...
CREATE TABLE IF NOT EXISTS `lt_attachment` (
...
CREATE TABLE IF NOT EXISTS `lt_dbsource` (
...
CREATE TABLE IF NOT EXISTS `lt_download` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `lt_field` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lt_guestbook` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `lt_kefu` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `listorder` int(10) unsigned NOT NULL DEFAULT '0',
  `createtime` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `lt_menu` (
...
CREATE TABLE IF NOT EXISTS `lt_module` (
...
-- CREATE TABLE IF NOT EXISTS `lt_order` (
--  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lt_page` (
...
CREATE TABLE IF NOT EXISTS `lt_posid` (
...
CREATE TABLE IF NOT EXISTS `lt_urlrule` (
...
CREATE TABLE IF NOT EXISTS `lt_block` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lt_slide` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(30) NOT NULL  DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `lt_slide_data` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lt_tags_data` (
...
CREATE TABLE IF NOT EXISTS `lt_online` (
...
CREATE TABLE IF NOT EXISTS `lt_payment` (
  `id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lt_cart` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `lt_order_data` (
  `id` int(11) unsigned   NOT NULL auto_increment,
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `lt_user_address` (
...
CREATE TABLE IF NOT EXISTS `lt_shipping` (
  `id` int(11)  unsigned  NOT NULL auto_increment,
  `name` varchar(50) NOT NULL DEFAULT '',
