  ...
  <section class="section">
    ...
    <form id="J_install_form" action="index.php?step=4" method="post">
      ...
      <div class="server">
          <table width="100%">
              <tr>
                  <td class="td1" width="100">网站类型</td>
                  <td class="td1" width="200">&nbsp;</td>
                  <td class="td1">&nbsp;</td>
              </tr>
              <tr>
                  <td class="tar">是否多语言：</td>
                  <td colspan="2"><input type="radio" name="lang" value="1"/> 多语网站 &nbsp;<input type="radio" name="lang" value="0"  checked /> 单语网站</td>
              </tr>
          </table>
        <table width="100%">
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="lowthink" class="input" onBlur="TestDbPwd(0)"></td>
            <td><div id="J_install_tip_dbname"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库表前缀：</td>
            <td><input type="text" name="dbprefix" id="dbprefix" value="lt_" class="input" ></td>
            <td><div id="J_install_tip_dbprefix"><span class="gray">建议使用默认，同一数据库安装多个LowThinkCMS时需修改</span></div></td>
          </tr>
          <tr>
          ...
          <table width="100%">
              ...
              <tr>
                  ...
                  <td><input type="text" name="sitename" value="LowThink内容管理框架" class="input"></td>
              ...
              <tr>
                  <td class="tar">关键词：</td>
                  <td><input type="text" name="sitekeywords" value="LowThinkPHP" class="input" autoComplete="off"></td>
                  <td><div id="J_install_tip_sitekeywords"></div></td>
              </tr>
              <tr>
                  <td class="tar">描述：</td>
                  <td><input type="text" name="siteinfo" class="input" value="LowThinkPHP是一款基于PHP+MySql开发的CMS系统，完全开源，微信小程序建站，就选LOWTHINK！LOWTHINK的开发旨在帮助创业者搭建企业平台，实现创业梦想。"></td>
          ...
          <table width="100%">
              ...
              <tr>
                  <td class="tar">密码：</td>
                  <td><input type="text" name="manager_pwd" id="manager_pwd" class="input" autoComplete="off"></td>
                  <td><div id="J_install_tip_manager_pwd"></div></td>
              </tr>
              <tr>
                  <td class="tar">重复密码：</td>
                  <td><input type="text" name="manager_ckpwd" id="manager_ckpwd" class="input" autoComplete="off"></td>
