    ...
    <form id="J_install_form" action="<?php echo $_SERVER['PHP_SELF']; ?>?step=4" method="post">
      ...
      <div class="server">
		...
		<table width="100%">
          ...
          <tr>
            <td class="tar">描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="CrmEb是一款基于PHP+MySql开发的Crm客户管理+Eb电商系统，其中免费版是完全开源的版本，采用MVC设计模式实现业务逻辑与表现层的适当分离，使网页设计师能够轻松设计出理想的模板，可面向中小型站点提供重量级微信公众号商城建设和微信小程序建设。对于那些想要进行开发，但技术不足的站长们是一个难得的系统。微信商城微信小程序建站，就选LOWTHINK！LOWTHINK的开发旨在帮助创业者搭建企业电商平台，实现创业梦想。"></td>
